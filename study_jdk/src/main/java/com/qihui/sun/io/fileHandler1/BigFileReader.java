...
//https://www.cnblogs.com/cutter-point/p/10560324.html
public class BigFileReader {
    ...
    private BigFileReader(File file,FileHandler handle,String charset,int bufferSize,int threadSize){
    ...
    public static class Builder{
        ...
        private FileHandler handle;
        private File file;
        public Builder(String file,FileHandler handle){
